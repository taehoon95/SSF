...
const PwdCheckviewContainer = ({history}) => {   
  ...
  const dispatch = useDispatch();
    ...
    const { u_name, u_id, u_pwd, pwd, u_email, u_pwdcheck,pwdupdateError,pwdupdate } = useSelector((state)=>{            
        console.log(state);
      return{        
        ...
        > */}
          ...
          <Grid container>
              <Grid item style={{ width:"100%" }}>
                <Typography variant="h6" style={{ color:"white", marginBottom:-15, marginTop:10 }}>비밀번호</Typography>
                <TextField
                  onChange={onChange}
                  onKeyUp={onKeyUpPWD}
            ...
            <Grid container>
              <Grid item style={{ width:"100%" }}>
                <Typography variant="h6" style={{ color:"white", marginBottom:-15, marginTop:10 }}>비밀번호 확인</Typography>
                <TextField
                  onChange={onChange}
