...
axios.post("https://teamstance.shop:8080/api/comment", { v_code, m_text, u_id })
//axios.post("https://18.219.234.0:8080/api/comment", { v_code, m_text, u_id })

export const commentUpdate = ({ m_num, m_text }) =>
axios.patch("https://teamstance.shop:8080/api/commentupdate",  { m_num, m_text })
//axios.patch("https://18.219.234.0:8080/api/commentupdate",  { m_num, m_text })

export const commentDelete = ({ m_num }) =>
axios.delete("https://teamstance.shop:8080/api/commentdelete",  { data : { m_num }})
